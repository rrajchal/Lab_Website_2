...
function switchPlayers(playerNum){
	...
	var avg_Pyards = (players[playerNum].pass_yards/players[playerNum].games_played).toFixed(0);
	var avg_Ryards = (players[playerNum].rushing_yards/players[playerNum].games_played).toFixed(0);
	var avg_RecYards = (players[playerNum].receiving_yards/players[playerNum].games_played).toFixed(0);
	...
	document.getElementById('avg_p_yards').innerHTML = avg_Pyards;
	document.getElementById('r_yards').innerHTML = players[playerNum].rushing_yards;
	document.getElementById('avg_r_yards').innerHTML = avg_Ryards;
	document.getElementById('rec_yards').innerHTML = players[playerNum].receiving_yards;
	document.getElementById('avg_rec_yards').innerHTML = avg_RecYards;
}
